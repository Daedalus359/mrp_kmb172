...
void set_example_object_frames(geometry_msgs::PoseStamped &object_poseStamped,
    ...
    //replace these with numbers that depend on the requested object
    ...
    object_poseStamped.pose.position.z = 0.549; //-0.125; //pose w/rt world frame
