...
void scanCallback(const sensor_msgs::LaserScan::ConstPtr& scan_in) {
    ...
    for (int i = 0; i < npts3d; i++) {
        ...
        else {//my work here: simply update the max/min values as needed, calculate tentative dimensions, and display
		...
		z_max = vec[2];
            ...
            ROS_WARN("(x_min, x_max, y_min, y_max, z_max) = (%6.3f, %6.3f, %6.3f, %6.3f, %6.3f)", x_min,x_max,y_min,y_max,z_max);
            ROS_INFO("(x_len,y_len,z_len) = (%6.3f, %6.3f, %6.3f)", (x_max - x_min),(y_max - y_min),z_max);
        }
    }
}
